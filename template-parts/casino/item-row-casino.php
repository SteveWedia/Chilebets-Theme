...
<?php $Wager = get_post_meta($post->ID, 'Casinowager', true); ?>
<?php $Percentage = get_post_meta($post->ID, 'Casinopercentage', true); ?>
<?php $Bonus = get_post_meta($post->ID, 'Casinobonus', true); ?>
...
<?php $Especial= get_post_meta($post->ID, 'Casinomaxbet', true); ?>
...
<tr class="table-row">
    ...
    <td class="title expand title-col">
    ...
    <td class="info custom expand sp-bet info-col" style="--field-title: 'PROSENT';">
    ...
    <td class="info custom expand sp-bet info-col" style="--field-title: 'BONO DE CASINO';">
    ...
    <td class="info custom expand sp-bet info-col" style="--field-title: 'ROLLOVER';">
    ...
    <td class="info custom expand sp-bet info-col" style="--field-title: 'TIRADAS GRATIS';">
